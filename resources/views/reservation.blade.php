			...
			<div class="row">
				<div class="col-lg-12 col-sm-12 col-xs-12">
					<div class="row-center">
						<form method="POST" action="/reservation/check" >
							@csrf
							<div class="row">
								<div class="col-md-6">
								<h3>Book a table</h3>
									<div class="col-md-12">
										...
										<input type="date" class="form-control" id="date" name="date" lang="en" placeholder="Enter date" required data-error="Please enter time">
										<script>
											$(function () {
									...
									<div class="col-md-12">
										<div class="form-group">
											<input type="time" id="input_time" name="time" class="time form-control picker__input" placeholder="Enter time" required data-error="Please enter time">
											<div class="help-block with-errors"></div>
										</div>                                 
									</div>
